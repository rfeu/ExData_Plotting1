...
png("plot4.png")
par (mfcol=c(2,2))
with(data, plot(completedate, Global_active_power, type ="l", xlab="", ylab="Global Active Power"))
...
legend("topright",bty="n", lty=1, col=c("black","red","blue"), legend = unique(data2$Sub_metering_type))
with(data, plot(completedate, Voltage, type ="l", xlab="", ylab="Voltage"))
with(data, plot(completedate, Global_reactive_power, type ="l", xlab="", ylab="Global_reactive_power"))
dev.off()
